...
text02=uicontrol(pict,'style','text','position',[70 195 390 40],'string','数字转汉语读音 v1.0','FontSize',20,'ForegroundColor','r');
text03=uicontrol(pict,'style','text','position',[0 192 500 10],'string','******************************************************************************************','FontSize',10,'ForegroundColor','b');
text1 = uicontrol(pict,'style','text','position',[0 153 100 30],'string','待读数字:','FontSize',12,'ForegroundColor','b');
con1 = uicontrol(pict,'style','edit','position',[95 157 400 30],'string','20220814.14156','FontSize',12,'ForegroundColor','r');
text4=uicontrol(pict,'style','text','position',[0 125 500 20],'string','++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++','FontSize',10,'ForegroundColor','r');
text3 = uicontrol(pict,'style','text','position',[0 88 90 30],'string','汉语读法:','FontSize',14,'ForegroundColor','r');
