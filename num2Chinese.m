function num2Chinese(con1,con2)
    ...
    if locF ~= 0
        switch(nc)
            case 1 % 万
                ...
                nstr = strcat(nstr,getChsInt(strInt(locF+1:end)),'点');
            case 2 % 亿
                nstr = strcat(getChsInt(strInt(1:locF)),'亿');
                nstr = strcat(nstr,getChsInt(strInt(locF+1:locF+4)),'万');
                nstr = strcat(nstr,getChsInt(strInt(locF+5:end)),'点');
            ...
            case 3 % 兆
                ...
                nstr = strcat(nstr,getChsInt(strInt(locF+9:end)),'点');
        end
    else
        switch(nc)
            case 2 % 万
            ...
            case 4 % 兆
                ...
                nstr = strcat(nstr,getChsInt(strInt(locF+13:end)),'点');
        end
    end
else
    nstr = strcat(getChsInt(strInt),'点');
end
